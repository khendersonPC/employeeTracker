...
class TableInternal {
    ...
    initDetailed(options) {
        ...
        this.columns =
            ((_a = options.columns) === null || _a === void 0 ? void 0 : _a.map((column) => (Object.assign(Object.assign(Object.assign({ name: column.name, title: column.title || column.name }, objIfExists('color', column.color)), objIfExists('maxLen', column.maxLen)), { alignment: column.alignment || table_constants_1.defaultRowAlignment })))) || [];
    }
